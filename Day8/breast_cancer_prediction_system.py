...
def breast_cancer_predict():
    ...
    tune=LogisticRegression(C=0.1,penalty='12',solver='liblinear',max_iter=10000,random_state=42)
    ...
    print("Matrix heatmap graphic generated successfully as 'confusion_matrix.png'.")
